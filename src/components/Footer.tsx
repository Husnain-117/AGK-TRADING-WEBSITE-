    ...
    <footer className="bg-muted border-t border-border mt-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold text-primary mb-4">FBL Group</h3>
            <p className="text-muted-foreground mb-4">
              Industrial Excellence Meets Innovation. Trusted by leading manufacturers worldwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-muted-foreground">Manufacturing</li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center text-muted-foreground">
                ...
                <a href="mailto:info@fblgroup.com" className="hover:text-primary transition-colors">
                  info@fblgroup.com
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center text-muted-foreground">
          <p>&copy; {currentYear} FBL Group. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
